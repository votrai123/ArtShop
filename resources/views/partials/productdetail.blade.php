        ...
        <div class="container">
            <div class="menu-prv1">
                <ul>
                    ...
                    <li><a href="">/</a></li>
                    <li><a href="">Calvin Klein Logo Sweatpants</a></li>
                </ul>
            </div>
            <div class="row">
                    ...
                    <div class="product-img-slide pro-v4">
                        <div class="product-images quickview">
                            <div class="main-img js-product-slider-normal">
                                <a href="#" class="hover-images effect"><img src="images/img68.jpg" alt="photo"
                        ...
                        <div class="multiple-img-list js-click-product-normal">
                            <div class="product-col">
                                <div class="img pro-v4 ">
                                    <img src="images/img69.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col">
                                <div class="img pro-v4">
                                    <img src="images/img70.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col">
                                <div class="img pro-v4">
                                    <img src="images/img38.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col">
                                <div class="img pro-v4">
                                    <img src="images/img18.jpg" alt="photo" class="img-responsive">
                                </div>
                            </div>
                            <div class="product-col">
                                <div class="img">
                                    <img src="images/img53.jpg" alt="photo" class="img-responsive style">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="product-info s8 pro-v1 pro-v4">
                        <div class="sale-para2 shop-1 pro-v1 shop-5 shop-6 shop-7 shop-8 pro-v1">
                            ...
                            <ul>
                                ...
                                <li><a class="sales-36-products" href="#">$36.00</a>
                                </li>

                            </ul>
                        </div>
                        <div class="short-desc">
                            <p class="product-desc s8 pro-v1 pro-v4">Typography is the work of typesetters, compositors,
                                typographers,<br> graphic designers, art directors, manga artists,comic book
                                artists,<br> graffiti artists.</p>
                        </div>
                        ...
                        <div class="zoa-qtt pro-v1">
                            ...
                            <button type="button" class="quantity-right-plus btn btn-number js-plus" data-type="plus"
                                data-field="">
                            </button>
                        </div>
        ...
        <div class="single-product-tab bd-bottom">
            ...
            <div class="tab-content">
                <div id="desc" class="tab-pane fade in ">
                    ...
                    <div class="para-v4">
                        <p><em>Duis id odio quis purus lacinia</em> viverra non eget sapien. Aenean sed tortor sapien.
                            Aenean ut iaculis justo, in hendrerit sem. Ut ac tincidunt velit, ac ultrices est.
                            <strong>Nullam eu massa auctor, </strong>aecenas in ligula neque. Etiam nec ligula finibus,
                            scelerisque tellus sed, rutrum mauris. Donec iaculis mattis interdum. Praesent et mauris non
                            orci lacinia dignissim. Pellentesque vel sapien <em>ut ante interdum aliquam.</em></p>
                    </div>
                    <div class="para-v4 bgr">
                        <p><span>"</span><em>Nullam eu massa auctor, euismod arcu eget, suscipit nisl. Maecenas in
                                ligula neque. Etiam nec ligula finibus, scelerisque tellus sed, rutrum mauris. Donec
                                iaculis mattis interdum. Praesent et mauris non orci lacinia dignissim. Pellentesque vel
                                sapien ut ante interdum aliquam.</em></p>
                    </div>
                    <div class="row two">
                        ...
                        <div class="col-md-8 col-sm-7 col-xs-12">
                            <div class="para-v4">
                                <p><em>Duis id odio quis purus lacinia</em> viverra non eget sapien. Aenean sed tortor
                                    sapien. Aenean ut iaculis justo, in hendrerit sem. Ut ac tincidunt velit, ac
                                    ultrices est. <strong>Nullam eu massa auctor, </strong>aecenas in ligula neque.
                                    Etiam nec ligula finibus, scelerisque tellus sed, rutrum mauris. Donec iaculis
                                    mattis interdum. Praesent et mauris non orci lacinia dignissim. Pellentesque vel
                                    sapien <em>ut ante interdum aliquam.</em></p>
                            </div>
                            <div class="para-v4">
                                <p><em>Duis id odio quis purus lacinia</em> viverra non eget sapien. Aenean sed tortor
                                    sapien. Aenean ut iaculis justo, in hendrerit sem. Ut ac tincidunt velit, ac
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-6 col-xs-12 pro-v4">
                                    <div class="para-details">
                                        <p>This lovely green striped dress with ruffles over the shoulders is by French
                                            designer Tartine et Chocolat.<br>
                                            Made in soft, fine cotton, it has beautifully embroidered dragonflies and
                                            sequinned flowers, and there are<br> mother-of-pearl logo button fasteners
                                            on the back.</p>
                                    </div>
                                    <div class="para-details">
                                        <p>Marco Campomaggi thinks, dreams, and designs collections of handbags, which
                                            combine the ancient<br>
                                            art of treating leather with creativity, precision, and painstaking care in
                                            craftsmanship. Unique,<br>
                                            one-of-a-kind, handmade bags, which do not get old after one season, but
                                            acquire value as time goes<br>
                                            by. Because time doesn’t take away; it enhances.</p>
                                    </div>
                                    <div class="notes">
                                        <ul>
    ...
    <div class="container">
        <div class="product-related pd-products">
            ...
            <div class="owl-carousel owl-theme owl-cate v2 js-owl-cate">
                ...
                <div class="product-item pro-v1">
                    <div class="product-img">
                        <a href=""><img src="images/img48.jpg" alt="" class="img-responsive"></a>
                        <div class="sale-img shop1 shop2">
                            <div class="before shop1 v2 pro-v1 before-pro-v1"></div>
                        </div>
                        <div class="ribbon zoa-hot shop-v1 new-pro-v1"><span>New</span></div>
